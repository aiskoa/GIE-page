              ...
              {activeTab === "general" ? (
                ...
                <>
                  ...
                  <div className="flex flex-wrap gap-3">
                    ...
                    >
                      <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
                        <path d="M17.523 15.3414c.5511 0 .9993-.4486.9993-1.002 0-.5534-.4482-1.002-.9993-1.002-.553 0-1.001.4486-1.001 1.002 0 .5534.448 1.002 1.001 1.002zm-11.046 0c.5511 0 .9993-.4486.9993-1.002 0-.5534-.4482-1.002-.9993-1.002-.553 0-1.001.4486-1.001 1.002 0 .5534.448 1.002 1.001 1.002zm5.523-11.046c-3.309 0-6 2.691-6 6v5.045h12v-5.045c0-3.309-2.691-6-6-6zm-3.501 1.5c.827 0 1.5.673 1.5 1.5s-.673 1.5-1.5 1.5-1.5-.673-1.5-1.5.673-1.5 1.5-1.5zm7.002 0c.827 0 1.5.673 1.5 1.5s-.673 1.5-1.5 1.5-1.5-.673-1.5-1.5.673-1.5 1.5-1.5z" />
                      </svg>
                      Android
                    </a>
                  </div>
